...
@WebServlet(name = "BlogDetailPublicController", urlPatterns = {"/BlogDetail"})
public class BlogDetailPublicController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (service) {
            case "blogDetail" -> {
                ...
                request.getRequestDispatcher("jsp/public/BlogPublicDetail.jsp").forward(request, response);
            }
            case "listByCategory" -> {
