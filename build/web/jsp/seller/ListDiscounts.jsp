<%-- 
    ...
    Created on : Jul 22, 2025, 10:03:10 PM
    Author     : tulok
--%>
                ...
                <div class="main-content-card animate-fade-in">
                    ...
                    <div class="controls">
                        <form action="" method="get">
                            ...
                            <input type="text" name="keyword" value="" placeholder="Search by name or ID..." required />
                            <button type="submit">Search</button>
                        </form>

                        <form action="list-voucher" method="get">
                            <input type="hidden" name="service" value="listVoucher"/>
                    ...
                    <table>
                        ...
                        <c:forEach var="d" items="${discounts}">
                            <tr>
                                ...
                                <td>${d.description}</td>
                                <td>
                                    <a class="action-btn" href="update-voucher?id=${d.discountID}">Update</a>
                                </td>
                                <td>
                                    <a class="action-btn" href="delete-voucher?id=${d.discountID}" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
