<%-- 
    ...
    Created on : May 29, 2025, 12:40:10 AM
...
<body class="account-page">
                  ...
                  <div class="settings-content">
                    ...
                    <div class="settings-section" data-aos="fade-up">
                      ...
                      <form class="php-email-form settings-form">
                          ...
                          <%
                                User user = (User) session.getAttribute("user"); // hoặc "newUser" nếu bạn đặt như vậy
                                if (user == null) {
                                    out.println("Không có thông tin người dùng.");
                                    return;
                                }
                            %>
                        ...
                        <div class="row g-3">
                          <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="firstName" value="<%= user.getFullName() %>" required="">
                          </div>
                          <div class="col-md-6">
                            <label for="lastName" class="form-label">Email: </label>
                            <input type="text" class="form-control" id="lastName" value="<%= user.getEmail() %>" required="">
                          </div>
                          <div class="col-md-6">
                            <label for="email" class="form-label">Phone: </label>
                            <input type="email" class="form-control" id="email" value="<%= user.getPhoneNumber() %>" required="">
                          </div>
                          <div class="col-md-6">
                            <label for="phone" class="form-label">Local Address: </label>
                            <input type="tel" class="form-control" id="phone" value="<%= user.getAddress() %>" required="">
                          </div>
                          <div class="col-md-6">
                            <label for="phone" class="form-label">Create Date: </label>
                            <input type="tel" class="form-control" id="phone" value="<%= user.getCreateDate().format(java.time.format.DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm")) %>" required="">
                          </div>
                          <div class="col-md-6">
                            <label for="phone" class="form-label">Status: </label>
                            <input type="tel" class="form-control" id="phone" value="<%= user.getStatus() %>" required="">
                          </div>
                          <div class="col-md-6">
                            <label for="phone" class="form-label">Description: </label>
                            <input type="tel" class="form-control" id="phone" value="<%= user.getDescription() == null ? "Không có" : user.getDescription() %>" required="">
                          </div>
                        </div>
  ...
  <script src="assets/js/main.js"></script>
    ...
    <%
        ...
        response.sendRedirect("index.html?msg=Đăng%20nhập%20thành%20công");
    %>
