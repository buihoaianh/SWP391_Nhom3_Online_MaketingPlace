<%-- 
    Document   : account
    Created on : Jun 3, 2025, 1:30:52 AM
    Author     : Admin
--%>
                                    ...
                                    <div class="tab-pane fade show active" id="orders">
                                        ...
                                        <div class="orders-grid">
                                            ...
                                            <div class="order-card" data-aos="fade-up" data-aos-delay="200">
                                                ...
                                                <div class="order-content">
                                                    <div class="product-grid">
                                                        <img src="${pageContext.request.contextPath}/assets/img/product/product-4.webp" alt="Product" loading="lazy">
                                                        <img src="${pageContext.request.contextPath}/assets/img/product/product-5.webp" alt="Product" loading="lazy">
                                                    </div>
                                                    <div class="order-info">
                                                        <div class="info-row">
                                                            <span>Status</span>
                                            ...
                                            <div class="order-card" data-aos="fade-up" data-aos-delay="300">
                                                ...
                                                <div class="order-content">
                                                    <div class="product-grid">
                                                        <img src="${pageContext.request.contextPath}/assets/img/product/product-6.webp" alt="Product" loading="lazy">
                                                    </div>
                                                    <div class="order-info">
                                                        <div class="info-row">
                                                            <span>Status</span>
                                            ...
                                            <div class="order-card" data-aos="fade-up" data-aos-delay="400">
                                                ...
                                                <div class="order-content">
                                                    <div class="product-grid">
                                                        <img src="${pageContext.request.contextPath}/assets/img/product/product-7.webp" alt="Product" loading="lazy">
                                                        <img src="${pageContext.request.contextPath}/assets/img/product/product-8.webp" alt="Product" loading="lazy">
                                                        <img src="${pageContext.request.contextPath}/assets/img/product/product-9.webp" alt="Product" loading="lazy">
