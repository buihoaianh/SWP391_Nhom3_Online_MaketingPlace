            ...
            <div class="product-images">
              ...
              <div class="product-thumbnails">
                <div class="swiper product-thumbnails-slider init-swiper">
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide thumbnail-item active" data-image="${detail.imageURL}">
                      <img src="${detail.imageURL}" alt="Product Thumbnail" class="img-fluid">
                    </div>
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="200">
            <div class="product-info">
              ...
              <div class="product-availability mb-4">
                ...
                <span>In Stock</span>
                <span class="stock-count">(${detail.quantity} items left)</span>
              </div>
