 ...
 * @author Admin
 */
@WebServlet(name = "AdminChangePassword", urlPatterns = {"/admin/admin-password"})
public class AdminChangePassword extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("/jsp/admin/ChangePassword.jsp").forward(request, response);
    }
    ...
    public String getServletInfo() {
        return "Handles password change for admin with full validation (no length check) and BCrypt encryption.";
    }
}
